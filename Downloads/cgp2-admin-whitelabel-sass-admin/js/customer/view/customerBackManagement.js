    ...
    Ext.create('Ext.ux.ui.GridPage', {
        ...
        tbarCfg: {
            ...
            btnCreate: {
                handler: function () {
                    JSOpen({
                        id: 'customerPage',
                        url: path + 'partials/customer/edit.html?type=customer',
                        title: i18n.getKey('创建后台账号'),
                        refresh: true
                    });
                }
            },
        ...
        gridCfg: {
            ...
            editActionHandler: function (grid, rowIndex, colIndex, view, event, record, dom) {
                ...
                JSOpen({
                    id: 'customerPage',
                    url: path + `partials/customer/edit.html?_id=${recordId}&type=customer`,
                    title: i18n.getKey(`编辑_后台账号(${recordId})`),
                    refresh: true
                });
            },
            columns: [
                ...
                },
                {
                    ...
                    clickHandler: function (value, metadata, record, rowIndex, colIndex, store, view) {
                        ...
                        JSOpen({
                            id: 'loginMethodPage',
                            url: path + `partials/customer/loginMethod.html?type=customer&id=${id}`,
            ...
            items: [
                ...
                },
                {
                    ...
                    store: Ext.create('CGP.common.store.AllWebsite', {
                        autoLoad: true,
                        params: {
                            filter: Ext.JSON.encode([{"name":"excludeIds","type": "number","value": "[11,12]"}])
                        }
                    }),
                    value: 5,
                    listeners: {
