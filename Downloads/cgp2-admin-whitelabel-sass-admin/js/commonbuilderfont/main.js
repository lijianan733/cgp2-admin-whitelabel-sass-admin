Ext.onReady(function () {
    var controller = Ext.create("CGP.commonbuilderfont.controller.Controller");
    ...
    var page = Ext.create('Ext.ux.ui.GridPage', {
        ...
        tbarCfg: {
            btnCreate: {
                ...
                handler: function () {
                    Ext.create('CGP.commonbuilderfont.view.AddFontWindow',{
                        store: page.grid.store,
                        grid: page.grid
                    }).show();
                }
            },
            btnDelete: {
                width: 150,
                text: i18n.getKey('config')+i18n.getKey('default')+i18n.getKey('font'),
                iconCls: 'icon_query',
                handler: function () {
                    controller.checkDefaultFont(page);
                }
            },
        ...
        gridCfg: {
            //store.js
            store: Ext.create("CGP.commonbuilderfont.store.BuilderFont"),
            frame: false,
            editAction: false,
            columnDefaults: {
