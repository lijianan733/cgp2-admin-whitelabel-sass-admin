Ext.define("CGP.threedpreviewplan.view.preview.ModelVariableTab", {
    ...
    initComponent: function () {
        ...
        var cameraForm = Ext.create('CGP.threedpreviewplan.view.preview.CameraInfo',{
            itemId: 'camera'
        });
        var navigationConfigForm = Ext.create('CGP.threedpreviewplan.view.preview.NavigationInfo',{
            itemId: 'navigationConfig'
        });

        me.items = [
            cameraForm ,navigationConfigForm
        ];
        me.bbar = ['->',{
