...
Ext.onReady(function(){
    ...
    var dsDataSource = null;
    if(urlParams.id != null){
        dsDataSource = Ext.ModelManager.getModel("CGP.dssheettemplateconfig.model.SheetTemplateConfig");
        //dsDataSource.
    }
            ...
            tbar : [{
                ...
                handler : function(){
                    ...
                    if(form.isValid()){
                        ...
                        controller.savePageContentSchema(items,dsDataSource,mask);
                    }
                }
            },{
                xtype : 'button',
...
//					urlParams.id = null;
                    ...
                    window.parent.Ext.getCmp("pagecontentschema_edit").setTitle(i18n.getKey('create') +"_"+ i18n.getKey('dsDataSource'));
                    var form = this.ownerCt.ownerCt;
                }
            },{
                xtype: 'button',
        ...
        listeners : {
            render : function(){
                var me = this;
                if(urlParams.id != null){
                    dsDataSource.load(Number(urlParams.id),{
                        success : function(record, operation){
                            dsDataSource = record;
