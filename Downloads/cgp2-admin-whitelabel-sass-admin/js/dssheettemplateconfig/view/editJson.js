Ext.define('CGP.dssheettemplateconfig.view.editJson', {
    ...
    initComponent: function () {
        ...
        if (Ext.isEmpty(me.sheetTemplateModel)) {
            previewData = {};
        } else {
            previewData = me.sheetTemplateModel.data;
        }
        ...
        me.bbar = [
            '->',
            {
                ...
                handler: function (comp) {
                    ...
                    controller.addPageTemplateConfigWin(jsonData, me.sheetTemplateModel, mask);
