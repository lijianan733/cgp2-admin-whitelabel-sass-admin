 ...
 *详细页
 **/
Ext.Loader.syncRequire(["CGP.threedmodelconfig.model.ConfigModel"]);
Ext.define('CGP.threedmodelconfig.edit', {
    ...
    initComponent: function () {
        ...
        if (!Ext.isEmpty(configModelId)) {
            configModel = Ext.ModelManager.getModel("CGP.threedmodelconfig.model.ConfigModel");
        }
                ...
                items: [
                    {
                        ...
                        handler: function () {
                            ...
                            controller.saveTreeDConfig(data, versionConfigs, configModelId, editOrNew, me);
                        }
                    }
                ]
        ...
        me.items = [
            Ext.create('CGP.threedmodelconfig.view.BaseInfo'),
            Ext.create('CGP.threedmodelconfig.view.ConfigVersionGrid', {
