Ext.define('CGP.dsurltemplate.view.editJson', {
    ...
    maximizable: true,
    itemId: "showJsonData",
    alias: 'urlTemplateInfo',

    initComponent: function () {
        var me = this;
        var previewData;
        me.title = i18n.getKey(me.createOrEdit);
        if (Ext.isEmpty(me.urlTemplateModel)) {
            previewData = {};
        } else {
            previewData = me.urlTemplateModel.data;
        }
        ...
        me.bbar = [
            '->',
            {
                ...
                handler: function (comp) {
                    ...
                    var controller = Ext.create('CGP.dsurltemplate.controller.Controller');
                    controller.addPageTemplateConfigWin(jsonData, me.urlTemplateModel, mask);
