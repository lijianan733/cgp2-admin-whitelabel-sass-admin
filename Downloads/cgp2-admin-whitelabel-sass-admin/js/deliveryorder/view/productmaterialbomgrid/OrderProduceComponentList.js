Ext.define('CGP.deliveryorder.view.productmaterialbomgrid.OrderProduceComponentList', {
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('CGP.deliveryorder.store.OrderProduceComponent', {
            params: {
            ...
            items: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var produceComponentInfos = Ext.create('CGP.deliveryorder.view.productmaterialbomgrid.ProduceComponentList', {
                            record: record,
