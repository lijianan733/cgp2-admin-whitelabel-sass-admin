Ext.define('CGP.deliveryorder.view.productmaterialbomgrid.ProduceComponentList', {
    ...
    initComponent: function () {
        var me = this;
        var controller = Ext.create('CGP.deliveryorder.controller.Status');
        ...
        Ext.Array.each(produceComponentInfos, function (item) {
            ...
            var machine = {
                ...
                //columnWidth: 140,
                store: Ext.create('CGP.deliveryorder.store.MachineModel', {
                    params: {
                        filter: filterString
                    }}),
                displayField: 'code',
