Ext.define('CGP.material.override.TreeStore', {
    ...
    filterListeners: {
        move: function(node, oldParent, newParent, index) {
            var me = this,
                snapshotNode = me.snapshot.findChild('_id', node.get('_id'), true),
                snapshotNewParent = me.snapshot.findChild('_id', newParent.get('_id'), true) || me.snapshot;
        ...
        append: function(parentNode, appendedNode, index) {
            var me = this,
                snapshotParentNode = me.snapshot.findChild('_id', parentNode.get('_id'), true) || me.snapshot,
                foundNode = me.snapshot.findChild('_id', appendedNode.get('_id'), true);
        ...
        insert: function(parentNode, insertedNode, refNode) {
            var me = this,
                snapshotParentNode = me.snapshot.findChild('_id', parentNode.get('_id'), true) || me.snapshot,
                foundNode = me.snapshot.findChild('_id', insertedNode.get('_id'), true);
        ...
        remove: function(parentNode, removedNode, isMove) {
            ...
            if (!isMove) {
                ...
                me.snapshot.findChild('_id', removedNode.get('_id'), true).remove(true);
            }
        }
    }
