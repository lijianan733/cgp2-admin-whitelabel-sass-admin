 ...
 * @date 2023/8/2
 */
Ext.define('CGP.USExemptionCert.controller.Controller', {
    /**
     *
     * @param nextStatus
     * @param grid
            ...
            bbar: {
                ...
                saveBtnCfg: {
                    handler: function (btn) {
                        ...
                        var jsonData = '';
                        url = adminPath + 'api/partner/exemptionCert/review/' + recordId;
                        jsonData = {
                            "remark": data.remark || '',
                            "status": data.status
                        };
                                ...
                                if (responseText.success) {
                                    ...
                                    Ext.Msg.confirm(i18n.getKey('prompt'), '修改成功,是否查看修改结果', function (selector) {
                                        if (selector == 'yes') {
                                            JSOpen({
                                                id: 'USExemptionCert',
                                                url: path + 'partials/USExemptionCert/main.html?_id=' + recordId,
                                                title: i18n.getKey('美国税豁免证明(已审核)'),
                                                refresh: true
                                            });
                                        }
                                    });
