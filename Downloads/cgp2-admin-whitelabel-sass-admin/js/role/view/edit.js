...
Ext.onReady(function () {
    ...
    var permissionStoreA = Ext.create("CGP.role.store.Permission", {
    ...
    var permissionGroupStoreA = Ext.create("CGP.role.store.Permission", {
        autoLoad: false,
        proxy: {
    ...
    function openWindow(button) {
        editPage;
        var record = editPage.form.getModel()[0];
        var editController = Ext.create("CGP.role.controller.Edit");
