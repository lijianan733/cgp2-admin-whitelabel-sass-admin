...
Ext.define('CGP.order.actions.address.view.BillingAddress', {
    extend: 'Ext.ux.form.Panel',

    requires: ['CGP.order.actions.address.model.BillingAddress', 'CGP.order.actions.address.store.Country', 'CGP.order.actions.address.store.LocationType'],
    ...
    model: 'CGP.order.actions.address.model.BillingAddress',
    ...
    constructor: function (config) {
        ...
        me.addEvents('sameaddress');
        config.items = [{
            xtype: 'displayfield',
            value: '<b>' + i18n.getKey('billingAddress') + '</b>',
            itemId: 'deliveryTitle'
        }, {
            xtype: 'checkbox',
            itemId: 'same',
            boxLabel: i18n.getKey('deliveryBillingSame'),
            inputValue: true,
            listeners: {
                change: function () {
                    me.fireEvent('sameaddress', this.checked);
                }
            }
        }, {
            xtype: 'numberfield',
    ...
    save: function (url, fn) {
        ...
        /*data.countryCode2 = data.country.isoCode2;
