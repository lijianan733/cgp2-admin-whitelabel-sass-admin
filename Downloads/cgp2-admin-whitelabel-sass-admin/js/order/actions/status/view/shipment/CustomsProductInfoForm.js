Ext.define('Order.status.view.shipment.CustomsProductInfoForm', {
    ...
    initComponent: function () {
        ...
        var boxDetails = record.get('boxProductItems');
        var detailItems = [];
        var index = 0;
            ...
            var boxDetailQty = {
                ...
                listeners: {
                    change: function (field, newValue, oldValue) {
                        ...
                        var boxProductItems = record.get('boxProductItems');
                        var totalWeight = 0;
                        var productQty = 0;
                        for (var i = 0; i < boxProductItems.length; i++) {
                            ...
                            if (i == index) {
                                boxProductItems[i].qty = newValue;
                                boxProductItems[i].netWeight = newValue * boxProductItems[i].weight;
                            }
                            totalWeight += boxProductItems[i].netWeight * me.boxQty;
                            productQty += boxQty * boxProductItems[i].qty;
                        }
                        record.beginEdit();
                        record.set('totalWeight', totalWeight);
                        record.set('productQty', productQty);
                        record.set('boxProductItems', boxProductItems);
                        record.endEdit();
