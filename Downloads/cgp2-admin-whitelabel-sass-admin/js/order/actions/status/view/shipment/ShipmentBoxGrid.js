Ext.define('Order.status.view.shipment.ShipmentBoxGrid', {
            ...
            items: [{
                    ...
                    listeners: {
                        headerclick: function () {
                            if (!me.model) {
                                me.model = Ext.ModelManager.getModel('Order.status.model.ShipmentBox');
                            }
                    ...
                    renderer: function (v, m, r) {
                        return {
                            ...
                            items: [{
                                ...
                                xtype: 'combobox',
                                store: Ext.create('Order.status.store.BoxSizeUnit'),
                                editable: false,
                                displayField: 'title',
                                valueField: 'vlaue',
                                name: 'boxSizeUnit',
