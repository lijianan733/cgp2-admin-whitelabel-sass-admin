...
Ext.define('CGP.editviewtypeconfigv3.view.EditViewConfigPanel', {
    ...
    initComponent: function () {
        var me = this;
        var controller = Ext.create('CGP.editviewtypeconfigv3.controller.Controller');
        me.items = [
            Ext.create('CGP.editviewtypeconfigv3.view.LeftGridPanel', {
                region: 'west',
                itemId: 'leftGridPanel',
                width: 320
            }),
            Ext.create('CGP.editviewtypeconfigv3.view.CenterFormPanel', {
                region: 'center',
    ...
    listeners: {
        afterrender: function (panel) {
            ...
            if (recordId) {
                ...
                CGP.editviewtypeconfigv3.model.EditViewConfigModel.load(recordId, {
                    scope: this,
