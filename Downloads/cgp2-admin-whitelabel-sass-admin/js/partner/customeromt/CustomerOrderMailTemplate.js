...
Ext.onReady(function () {
    ...
    var store = Ext.create('CGP.partner.customeromt.store.CustomerOmtStore', {
        type: 'customer',
        ...
        tbarCfg: {
            btnCreate: {
                handler: function (view) {
                    mailTemplateTabs.addCustEditTab(null, i18n.getKey('user') + i18n.getKey('notifyEmailConfig'));
                }
            },
            btnDelete: {
                handler: function (view) {
                    ...
                    items: [
                        {
                            ...
                            handler: function (gridview, recordIndex, cellIndex, fun, button, record) {
                                var id = record.getId();
                                mailTemplateTabs.addCustEditTab(id, i18n.getKey('user') + i18n.getKey('notifyEmailConfig'));
                            }
                        },
                        {
