...
Ext.define('CGP.partner.customeromt.view.CreateOrEditForm', {
    ...
    showAllEnablePlaceholder: function () {
        ...
        if (!Ext.getCmp('CreateOrEditFormshowjsondatawindow')) {
            var win = Ext.widget('showjsondatawindow', {
                id: 'CreateOrEditFormshowjsondatawindow',
                rawData: localData,
                title: '查看可用占位符'
            });
            win.show();
            ...
            tbar: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        mailTemplateTabs.setActiveTab(window.parent.Ext.getCmp('usermailtemplate'));
                    }
                }
            ]
        }, config);
