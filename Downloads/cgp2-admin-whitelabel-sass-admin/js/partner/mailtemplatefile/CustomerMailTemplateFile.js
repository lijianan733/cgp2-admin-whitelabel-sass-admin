Ext.onReady(function(){
    ...
    var page = Ext.create('Ext.ux.ui.GridPage', {
        ...
        block: 'mailtemplate',
        // 编辑页面
        editPage: 'customerfileedit.html',
        tbarCfg: {
            disabledButtons: ['delete'],
            btnCreate : {
//				disabled : true,
                handler : function() {
                    mailTemplateTabs.addCustFileEditTab(null,i18n.getKey('customerMailTemplateFile'));
                }
            }
        },
        height : '100%',
    ...
    function showTabEdit(gridview, recordIndex, cellIndex, fun,button,record){
        var id = record.getId();
        mailTemplateTabs.addCustFileEditTab(id,i18n.getKey('customerMailTemplateFile'));
    }
})
