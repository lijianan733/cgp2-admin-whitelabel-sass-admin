...
Ext.onReady(function () {
    ...
    Ext.ModelManager.getModel('CGP.partner.mailtemplatefile.MailTemplateFileModel').getProxy().extraParams =  {target: 'customer',partnerId: partnerId,websiteId: websiteId};
    var page = Ext.widget({
        block: 'partner',
        xtype: 'uxeditpage',
        columns: 1,
