 ...
 */
Ext.define('CGP.partner.view.orderstatuschangenotifyconfig.view.RestRequestConfig', {
    ...
    initComponent: function () {
        ...
        var restHttpRequestConfigStore = me.store = Ext.create('Ext.data.Store', {
            model: 'CGP.partner.view.orderstatuschangenotifyconfig.model.RestHttpRequestConfigModel',
            autoSync: true,
            autoLoad: true,
            proxy: {
                type: 'memory',
