 ...
 */
Ext.define('CGP.partner.view.supportableproduct.view.ReceiveAddressWindow', {
    ...
    initComponent: function () {
        var me = this;
        var enableAddressStore = Ext.create('CGP.partner.view.supportableproduct.store.EnableAddressStore', {
            params: {
