...
Ext.onReady(function () {
    var store = Ext.create('CGP.partner.view.supplieroderstatuschangeemailnotifyconfig.store.OrderStatusChangeMailConfigStore', {
        params: {
            filter: '[{"name":"type","value":"backstage","type":"string"}]'
        }
    });
        ...
        tbarCfg: {
            btnCreate: {
                handler: function (view) {
                    controller.showBackstageEditOrCreateConfigPage(tab, 'create', partnerId)
                }
            },
            btnDelete: {
                handler: function (view) {
                    ...
                    items: [
                        {
                            ...
                            handler: function (gridview, recordIndex, cellIndex, fun, button, record) {
                                var id = record.getId();
                                controller.showBackstageEditOrCreateConfigPage(tab, 'edit', partnerId, id);
