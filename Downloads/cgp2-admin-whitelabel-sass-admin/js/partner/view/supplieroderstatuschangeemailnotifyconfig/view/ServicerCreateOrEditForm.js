...
Ext.define('CGP.partner.view.supplieroderstatuschangeemailnotifyconfig.view.ServicerCreateOrEditForm', {
    ...
    showAllEnablePlaceholder: function () {
        ...
        if (!Ext.getCmp('ServicerCreateOrEditFormShowjsondatawindow')) {
            var win = Ext.widget('showjsondatawindow', {
                id: 'ServicerCreateOrEditFormShowjsondatawindow',
                rawData: localData,
                title: '查看可用占位符'
            });
            win.show();
