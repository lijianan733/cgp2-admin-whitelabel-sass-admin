Ext.define('CGP.partner.view.ManagerEmailSendMail', {
    ...
    initComponent: function () {
        var me = this;
        var fieldText = null;
        me.title = i18n.getKey('managerEmailSendMail');
            ...
            callback: function (records, options, success) {
                function addFieldText(records) {
                    ...
                    var myLabelkey = [
                        {
                            title: "host",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_HOST'
                        },
                        {
                            title: "address",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_ADDRESS'
                        },
                        {
                            title: "username",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_USERNAME'
                        },
                        {
                            title: "password",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_PASSWORD'
                        },
                        {
                            title: "port",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_PORT'
                        },
                        {
                            title: "timeout",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_TIMEOUT'
                        },
                        {
                            title: "protocol",
                            key: keyhead + '_CONFIG_KEY_EMAIL_SERVICE_PROTOCOL'
                        }
                    ];
