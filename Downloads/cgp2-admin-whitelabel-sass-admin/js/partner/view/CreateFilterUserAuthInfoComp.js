 ...
 * @date 2025/9/28
 */
Ext.define('CGP.partner.view.CreateFilterUserAuthInfoComp', {
    ...
    initComponent: function () {
        ...
        me.items = [
            ...
            },
            {
                ...
                listeners: {
                    change: function (comp, newValue) {
                        var userAuthInfosAuthType = comp.ownerCt.getComponent('userAuthInfos.authType');
                        
                        userAuthInfosAuthType.isFilterComp = !newValue;
                        comp.isFilterComp = !newValue;
                    }
                }
            },
        ]
