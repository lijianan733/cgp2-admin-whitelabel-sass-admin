...
Ext.define('CGP.configuration.serviceomt.view.CreateOrEditForm', {
    ...
    showAllEnablePlaceholder: function () {
        ...
        if (!Ext.getCmp('ServiceomtCreateOrEditFormshowjsondatawindow')) {
            var win = Ext.widget('showjsondatawindow', {
                id: 'ServiceomtCreateOrEditFormshowjsondatawindow',
                rawData: localData,
                title: '查看可用占位符'
            });
            win.show();
        ...
        applyConfig2 = Ext.Object.merge({
            ...
            tbar: [
                ...
                },
                {
                    ...
                    iconCls: 'icon_grid',
                    handler: function () {
                        window.parent.returnServerMailTemplate();
                    }
                }
            ]
        }, config);
