...
Ext.onReady(function () {
    var store = Ext.create('CGP.configuration.serviceomt.store.ServiceOmtStore', {
        type: 'backstage'
    });
...
//				disabled : true,
                handler: function () {
                    var id = null;
                    window.parent.addServerEditTab(id, i18n.getKey('server') + i18n.getKey('notifyEmailConfig') + i18n.getKey('config'));
                }
            },
            btnDelete: {
                    ...
                    items: [
                        {
                            ...
                            handler: function (gridview, recordIndex, cellIndex, fun, button, record) {
                                var id = record.getId();
                                window.parent.addServerEditTab(id, i18n.getKey('server') + i18n.getKey('notifyEmailConfig'));
                            }
                        },
                        {
