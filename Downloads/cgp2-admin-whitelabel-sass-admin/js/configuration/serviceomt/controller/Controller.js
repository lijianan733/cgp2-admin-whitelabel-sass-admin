...
Ext.define('CGP.configuration.serviceomt.controller.Controller', {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                if (responseMessage.success) {
                    ...
                    Ext.Msg.alert(i18n.getKey('prompt'), i18n.getKey('saveSuccess'),function(){window.parent.addServerEditTab(id, i18n.getKey('Service Order Mail Template'))});
                } else {
