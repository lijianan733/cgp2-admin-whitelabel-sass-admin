...
Ext.onReady(function () {
    ...
    var page = Ext.create('Ext.form.Panel', {
        title: i18n.getKey("register mail") + i18n.getKey('paramconfig'),
        height: 400,
        width: 500,
        region: 'center',
        frame: false,
...
//					'font-size:18px;">'+ getQueryString("website") +': register mail param config</div>'
//		}
        ],
        listeners: {
    ...
    // store加载数据
    store.load({
        params: {groupId: 3, website: '' + getQueryString("website") + ''},
