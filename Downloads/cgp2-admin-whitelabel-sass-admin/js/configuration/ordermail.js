...
Ext.onReady(function(){
	...
	var page = Ext.create('Ext.form.Panel',{
		title: i18n.getKey('order mail')+i18n.getKey('paramconfig'),
//		height: 400,
//		width: 500,
		region: 'center',
		frame: false,
...
//					'font-size:18px;">'+ getQueryString("website") +':'+i18n.getKey('ordermail') + i18n.getKey('paramconfig') +'</div>'
//		}
		],
		listeners:{
...
//			}
	...
	store.load({
		params : {groupId : 8, website: ''+getQueryString("website")+''},
