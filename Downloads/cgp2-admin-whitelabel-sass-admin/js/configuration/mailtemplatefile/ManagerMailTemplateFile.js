...
//				disabled : true,
                handler : function() {
                    window.parent.addServerFileEditTab(null,i18n.getKey('managerMailTemplateFile'));
                }
            }
        },
        height : '100%',
    ...
    function showTabEdit(gridview, recordIndex, cellIndex, fun,button,record){
        var id = record.getId();
        window.parent.addServerFileEditTab(id,i18n.getKey('managerMailTemplateFile'));
    }
})
