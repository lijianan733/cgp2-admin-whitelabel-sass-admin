...
Ext.define('CGP.configuration.customeromt.view.CreateOrEditForm', {
    ...
    showAllEnablePlaceholder: function () {
        ...
        if (!Ext.getCmp('CustomeromtCreateOrEditFormshowjsondatawindow')) {
            var win = Ext.widget('showjsondatawindow', {
                id: 'CustomeromtCreateOrEditFormshowjsondatawindow',
                rawData: localData,
                title: '查看可用占位符'
            });
            win.show();
            ...
            tbar: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        window.parent.Ext.getCmp("custmailtpedit").setTitle(i18n.getKey('create') + "_" + i18n.getKey('user') + i18n.getKey('notifyEmailConfig'));
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        if (form.recordId != null) {
                            var controller = Ext.create('CGP.configuration.customeromt.controller.Controller');
                            var MailTemplateStore = Ext.create('CGP.configuration.customeromt.store.CustomerOmtStore', {
                                type: 'customer',
                                params: {
                ...
                },
                {
                    ...
                    iconCls: 'icon_grid',
                    handler: function () {
                        window.parent.returnUserMailTemplate();
                    }
                }
            ]
        }, config);
