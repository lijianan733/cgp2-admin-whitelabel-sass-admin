Ext.define('CGP.materialviewtype.view.edit.PageContentInstanceCfg', {
    ...
    initComponent: function(){
        var me = this;
        me.title = i18n.getKey('pageContentInstanceConfig');
        ...
        var pageContentInstanceRange = Ext.create('CGP.product.view.managerskuattribute.view.edit.CusFieldContainer', Ext.Object.merge(contentPageConfig, {itemId: 'pageContentRange',
            name: 'pageContentInstanceRange', fieldLabel: i18n.getKey('pageContentInstanceRange')}));
        me.items = [
            {
                ...
                fieldLabel: i18n.getKey('pageContentIndex Expression')
