 ...
 */
Ext.Loader.syncRequire(['CGP.feign_log.model.FeignLogModel']);
    ...
    var form2 = Ext.create('Ext.form.Panel', {
        ...
        listeners: {
            afterrender: function () {
                var me = this
                var url = adminPath + 'api/feignLogInfo/' + recordId;
        ...
        items: [
            {
                ...
                items: [
                    {
                        itemId: 'env',
                        fieldLabel: i18n.getKey('env'),
                        name: 'env'
                    },
                    {
                        itemId: 'requestMethod',
                        fieldLabel: i18n.getKey('requestMethod'),
                        name: 'requestMethod'
                    },
                    {
                        itemId: 'responseStatusCode',
                        fieldLabel: i18n.getKey('responseStatusCode'),
                    ...
                    {
                        itemId: 'requestUrl',
                        fieldLabel: i18n.getKey('requestUrl'),
                        name: 'requestUrl'
                    },
                ]
            },
            {
                xtype: 'fieldset',
                title: "<font style= 'font-size:15px;color:green;font-weight: bold'>" + i18n.getKey('requestHeaders') + '</font>',
                collapsible: true,
                collapsed: false,
                setValue: function (data) {
                    var me = this;
                    if (data) {
                        ...
                        var info = JSJsonToTree(data).children;
                        if (info && info.length > 0) {
                            me.items.items[0].getStore().getRootNode().appendChild(info);
                        }
                        me.show();
                    } else {
                        me.hide();
            ...
            {
                xtype: 'fieldset',
                title: "<font style= 'font-size:15px;color:green;font-weight: bold'>" + i18n.getKey('responseHeaders') + '</font>',
                collapsible: true,
                border: '1 0 0 0 ',
                collapsed: false,
                setValue: function (data) {
            ...
            {
                xtype: 'fieldset',
                title: "<font style= 'font-size:15px;color:green;font-weight: bold'>" + i18n.getKey('responseBody') + '</font>',
                collapsible: true,
                collapsed: false,
                border: '1 0 0 0 ',
                layout: 'fit',
                ...
                setValue: function (data) {
                    ...
                    if (data) {
                        ...
                        me.items.items[0].value = Ext.clone(result);
                        var info = JSJsonToTree(result).children;
                        if (info && info.length > 0) {
                            me.items.items[0].getStore().getRootNode().appendChild(info);
                        }
                        me.show();
