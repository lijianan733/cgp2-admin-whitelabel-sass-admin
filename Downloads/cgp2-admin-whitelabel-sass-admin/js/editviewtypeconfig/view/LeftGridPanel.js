 ...
 */
Ext.define('CGP.editviewtypeconfig.view.LeftGridPanel', {
        ...
        areaTypes: ['H1', 'Bottom', 'Left', 'Right', 'Document'],
        listeners: {
            ...
            me.columns = [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record, rowIndex, colIndex, store, gridView) {
                        ...
                        var checked = (area == 'H1' || area == 'Document') || value
                        return {
                            xtype: 'checkbox',
                            inputValue: true,
                            readOnly: area == 'H1' || area == 'Document',
                            checked: (area == 'H1' || area == 'Document') || value,
                            fieldStyle: (area == 'H1' || area == 'Document') ? 'background-color:silver' : null,
