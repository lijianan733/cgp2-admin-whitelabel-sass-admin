/**
 * @Description:模仿'Ext.util.Observable'
 * @author nan
 * @date 2022/3/10
 */
//引入指定样式表
Ext.util.CSS.swapStyleSheet('viewer', path + 'css/viewer/viewer.css');
Ext.define('CGP.common.controller.ImageView',
    function () {
        var me = this;
        console.log('aaaaaaa');
        return {
            ...
            buildImageView: function (img, options) {
                var me = this;
                return new me.ImageView(img, options);
            },
            constructor: function (config) {
                this.buildImageView({img, options} = config);
            }
        }
    },
    function (imageView) {
        ...
        this.prototype.ImageView = ImageView;
    }
);
