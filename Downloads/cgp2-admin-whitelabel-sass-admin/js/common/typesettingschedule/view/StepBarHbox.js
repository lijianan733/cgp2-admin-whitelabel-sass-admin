...
Ext.Loader.syncRequire([
    'CGP.common.typesettingschedule.view.OriginalStepItems'
])
Ext.define('CGP.common.typesettingschedule.view.StepBarHbox', {
    extend: 'Ext.container.Container',
    alias: 'widget.stepbarhbox',
