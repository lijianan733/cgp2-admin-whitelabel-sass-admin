...
Ext.Loader.syncRequire([
    'CGP.common.typesettingschedule.view.StepItems'
])
Ext.define('CGP.common.typesettingschedule.view.StepBar', {
    ...
    initComponent: function () {
        ...
        me.data?.map(function (item, index, arr) {
            var heights;
            var height = item['heights'];
            if (typeof height === 'string') {
                heights = me.height * +height.substring(0, height.indexOf('%'))/100;
            } else {
                heights = height
            }
