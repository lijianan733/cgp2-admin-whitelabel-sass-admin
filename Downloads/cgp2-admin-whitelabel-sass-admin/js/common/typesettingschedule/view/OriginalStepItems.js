 ...
 * @date 2023/1/11
 */
Ext.define('CGP.common.typesettingschedule.view.OriginalStepItems', {
    extend: 'Ext.Component',
    alias: 'widget.originalstepitems',
    baseCls: '',
    animate: true,
    text: '',
    style: {},
    ...
    renderTplVbox: [
        '<tpl>',
        '<div class="steps-center" style="height: 100%;">',
        '<div class="step-line-box {stepStatusCls}" style="display: inline-block;width: 50%;height: 100%;">',
        '<div class="step-line {stepLineCls}" style="top: -100%;height: 100%;width: 2px;left: 48%; margin: auto;display:{[values.isShowLine==false?\'none\':\'block\']} "></div>',
        '<div class="{iconCls}" itemId="step-icon">',
        '<div class="{classNameCls}">{schedule}</div>',
        '</div>',
        '</div>',
    ...
    initRenderData: function () {
        ...
        return {
            ...
            iconMargin: me.status === -2 ? (me.schedule <= 10 ? '3px 0 0 0' : '3px 0 0 -6px') : '3px 0 0 0'
        };
    },
    onRender: function () {
        var me = this;
...
//@ sourceURL=https://dev-sz-qpson-nginx.qppdev.com/product-library/js/common/steps/StepItems.js