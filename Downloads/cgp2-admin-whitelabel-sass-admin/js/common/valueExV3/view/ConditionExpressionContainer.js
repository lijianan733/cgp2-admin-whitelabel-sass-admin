...
Ext.define('CGP.common.valueExV3.view.ConditionExpressionContainer', {
    extend: 'Ext.ux.form.field.UxFieldContainer',
    alias: 'widget.conditionexpressioncontainer',
    defaults: {},
    ...
    initComponent: function () {
        var me = this;
        var operatorStore = Ext.create('CGP.common.valueExV3.store.OperatorStore');
        var leftStore = me.leftStore || Ext.create('Ext.data.TreeStore', {
            ...
            root: {
                expanded: true,
                children: JSJsonToTree(CGP.common.valueExV3.config.Config2.data).children
            }
        });
        ...
        me.items = [
            {
                ...
                setValue: function (valueInit) {
                    ...
                    Ext.each(me.recursiveRecords, function (record) {
                        ...
                        if (index != -1) {
                            valueFin.push(me.getDisplayName(record));
