Ext.define("CGP.common.smtselector.SelectBomTreeNodeWindow", {
    ...
    initComponent: function () {
        ...
        var store = Ext.create('CGP.mmaterialprocess.mbom.view.mbomsbomrelationship.store.SellBomTreeStore', {
            root: me.root
        });
