/**
 * Created by nan on 2018/3/15.
 */
Ext.define('CGP.common.valueEx.view.ManagerSkuAttrConstraintGrid', {
    ...
    initComponent: function () {
        ...
        me.columns = [
                ...
                items: [
                    {
                        ...
                        handler: function (view, rowIndex, colIndex,event,el,record) {
                            ...
                            me.controller.selectConstraintType(me.skuAttributeId, recordId, me.tabPanel, 'edit', me.inputTypeClazz, me.store.getAt(rowIndex).data, me.configurableId,record);
                        }
                    },
                    {
            ...
            },
            {
                ...
                menuDisabled:true,
                sortable:false,
                hidden: !(me.inputTypeClazz == 'com.qpp.cgp.value.constraint.ContinuousValueConstraint'),
            ...
            },
            {
                ...
                menuDisabled:true,
                sortable:false,
                hidden: !(me.inputTypeClazz == 'com.qpp.cgp.value.constraint.DiscreteValueConstraint'),
                xtype: 'componentcolumn',
                renderer: function (value, metadata, record) {
                    if (!Ext.isEmpty(value)) {
                        return {
