...
Ext.define('CGP.common.condition.view.CustomConditionPanel', {
    ...
    //在指定dom中光标处加入文本
    tbarConfig: {
        displayfieldCfg: null,
        expressionTestCfg: null,
        usetemplatebtnCfg: null,
        helpInfoCfg: null,
        editExpressionCfg: null
    },
    ...
    initComponent: function () {
        ...
        if (Ext.isEmpty(me.contentTemplate) && !Ext.isEmpty(me.contentAttributeStore)) {
            me.contentTemplate = me.buildContentTemplate(me.contentAttributeStore);
        }
            ...
            items: [
                {
                    ...
                    tbar: {
                        ...
                        items: [
                            ...
                            }, me.tbarConfig?.displayfieldCfg),
                            Ext.Object.merge({
                                xtype: 'button',
                                text: '校验语法',
                                iconCls: 'icon_test',
                                handler: function (btn) {
                                    var leftPanel = btn.up('[itemId=leftPanel]');
                            ...
                            }, me.tbarConfig?.expressionTestCfg),
                            Ext.Object.merge({
                                xtype: 'usetemplatebtn',
                                text: '模板',
                            }, me.tbarConfig?.usetemplatebtnCfg),
                            Ext.Object.merge({
                                xtype: 'button',
                                text: '显示帮助信息',
                                count: 0,
                                ...
                                handler: function (btn) {
                                    ...
                                    panel.ownerCt.showHelpInfo()
                                }
                            }, me.tbarConfig?.helpInfoCfg),
                            Ext.Object.merge({
                                xtype: 'button',
                                text: '编辑表达式',
                                itemId: 'edit',
                            ...
                            }, me.tbarConfig?.editExpressionCfg),
                        ]
                    },
                    bodyStyle: {
                        borderColor: 'silver'
                    ...
                    items: [{
                        ...
                        listeners: {
                            el: {
                                dblclick: function (event, textarea) {
                                    var leftPanel = me;
                                    var editBtn = leftPanel.down('[itemId=edit]');
                ...
                },
                {
                            ...
                            Ext.create('Ext.tip.ToolTip', {
                                ...
                                listeners: {
                                    ...
                                    beforeshow: function (tip) {
                                        ...
                                        var contentAttributeStore = customConditionPanel.contentAttributeStore;
                                        var attributeRecord = contentAttributeStore.findRecord('key', value);
                                        if (attributeRecord) {
                    ...
                    columns: [
                        {
                            xtype: 'treecolumn',
                            text: '<font color="green">上下文变量</font>(双击在鼠标位置加入属性)',
                            height: 37,
                            dataIndex: 'text',
                            flex: 1,
