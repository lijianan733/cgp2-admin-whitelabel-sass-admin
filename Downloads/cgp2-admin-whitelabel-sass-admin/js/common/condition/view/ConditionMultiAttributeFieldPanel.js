...
Ext.Loader.syncRequire([
    'CGP.common.condition.view.MultiAttributePicker'
])
Ext.define('CGP.common.condition.view.ConditionMultiAttributeFieldPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.multiattributeconditiongridpanel',
    layout: 'vbox',
    maxHeight: 350,
    minHeight: 150,
    autoScroll: true,
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function (btn) {
                        ...
                        if (Ext.isEmpty(win)) {
                            win = Ext.create('CGP.common.condition.view.ContextWindow', {
                                expressionTextarea: null,
                                id: 'contextWindow',
                                contentAttributeStore: contentAttributeStore,
                            });
                        }
                        win.showAt(expressionField.getX(), expressionField.getY() + 30);
                        console.log(this);
                    }
                }
            ]
    ...
    createMultiAttributeConstraint: function (value) {
        ...
        var attributeField = {
            xtype: 'multiattributepicker',
            flex: 2,
            itemId: 'attributeField',
            margin: '0 10 0 0',
            allowBlank: false,
            emptyText: '例如：{上下文属性A}+{上下文属性B}',
