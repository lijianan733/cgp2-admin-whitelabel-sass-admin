/**
 * @Description: 一个步骤栏的节点
 * @author nan
 * @date 2022/6/6
 */
Ext.define('CGP.common.steps.StepItems', {
    ...
    renderTplVbox: [
        ...
        '<div class="step-line {stepLineCls}" style="top: -100%;height: 100%;width: 2px;left: 48%; margin: auto;' +
        'display:{[values.isShowLine==false?\'none\':\'block\']} "></div>',
        '<div class="{iconCls}" itemId="step-icon">',
        '<div class="step-icon-bullets"></div>',
        '</div>',
        '</div>',
    ...
    /**
     * 根据配置修改显示样式
     * @returns {{stepLineCls: null, stepDesc: null, itemCls: string, stepName: null, isShowLine: boolean, iconCls: string, stepStatusCls: null, status: (number|*)}}
     */
