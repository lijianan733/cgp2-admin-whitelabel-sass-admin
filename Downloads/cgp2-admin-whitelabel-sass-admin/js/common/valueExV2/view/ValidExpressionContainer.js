 ...
 */
Ext.syncRequire(['CGP.currency.store.Currency', 'CGP.common.valueExV2.view.DiyComponent']);
Ext.define('CGP.common.valueExV2.view.ValidExpressionContainer', {
    ...
    layout: 'anchor',
    uxTextareaContextData: null,//自定义的textarea中展示的上下文提示信息，json格式数据
    /**
     * 自定义校验
     */
    isValid: function () {
        ...
        for (var i = 0; i < me.items.items.length; i++) {
            result += me.items.items[i].isValid();
        }
    ...
    constructor: function (config) {
        ...
        var expressionStore = Ext.create('Ext.data.Store', {
            ...
            fields: [
                ...
                {name: 'min', type: 'object', defaultValue: null},
                {name: 'max', type: 'object', defaultValue: null},
                {name: 'regexTemplate', type: 'object', defaultValue: null}
            ],
            data: []
        });
        me.commonPart = [
                ...
                listeners: {
                    'change': function (view, newValue, oldValue) {
                        ...
                        if (newValue == 'com.qpp.cgp.expression.RangeExpression') {
                            this.ownerCt.add([Ext.create('CGP.common.valueExV2.view.DiyComponent', {
                                name: 'min',
                                itemId: 'min',
                                ...
                                Ext.create('CGP.common.valueExV2.view.DiyComponent', {
                                    name: 'max',
                                    itemId: 'max',
                                    configurableId: me.configurableId,
            ...
            },
            {
                ...
                toolbarConfig: {
                    items: [
                        {
                            xtype: 'button',
                            text: i18n.getKey('可用的占位符'),
                            iconCls: 'icon_tool', //your iconCls here
                            handler: function () {
                                var localData = me.uxTextareaContextData || null
                                if (!Ext.getCmp('UxTextarea')) {
