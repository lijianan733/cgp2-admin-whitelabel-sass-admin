...
Ext.syncRequire([
    ...
    'CGP.common.valueExV2.model.SkuAttributeConstraint'
]);
Ext.define('CGP.common.valueExV2.GroupGridPanel', {
    ...
    setValue: function (sourceData) {
        ...
        for (var i = 0; i < sourceData.length; i++) {
            if (sourceData[i].clazz == 'com.qpp.cgp.value.constraint.DiscreteValueConstraintItem') {
                discreteValueConstraintDataArray.push(sourceData[i]);
            } else {
                continuousValueConstraintDataArray.push(sourceData[i]);
            }
        }
        var discreteValueConstraintGrid = me.addGrid(discreteValueConstraintDataArray, 'com.qpp.cgp.value.constraint.DiscreteValueConstraintItem');
    ...
    addGrid: function (recordArray, inputTypeClazz) {
        ...
        var store = Ext.create('Ext.data.Store',
            {
                id: JSGetUUID(),
                model: 'CGP.common.valueExV2.model.SkuAttributeConstraint',
                data: recordArray,
                proxy: {
        ...
        var inputType = inputTypeClazz == 'com.qpp.cgp.value.constraint.DiscreteValueConstraintItem' ? 'DiscreteValueConstraint' : 'ContinuousValueConstraint';
        var gridType = '';
        if (inputType == 'DiscreteValueConstraint') {
            gridType = 'CGP.common.valueExV2.view.ManagerDiscreteValueConstraintGrid'
        } else {
            gridType = 'CGP.common.valueExV2.view.ManagerContinuousValueConstraintGrid'
        }
                            ...
                            data: [
                                {
                                    ...
                                    value: 'com.qpp.cgp.value.constraint.DiscreteValueConstraintItem'
                                },
                                {
                        ...
                        handler: function (view) {
                            ...
                            if (type == 'com.qpp.cgp.value.constraint.ContinuousValueConstraint') {
                                ...
                                var EditDiscreteValueConstraintForm = Ext.create('CGP.common.valueExV2.view.EditDiscreteValueConstraintForm', {
                                    ...
                                    currentPanel: me,
                                    editPanel: panel,
                                    inputTypeClazz: 'com.qpp.cgp.value.constraint.DiscreteValueConstraintItem'
                                });
