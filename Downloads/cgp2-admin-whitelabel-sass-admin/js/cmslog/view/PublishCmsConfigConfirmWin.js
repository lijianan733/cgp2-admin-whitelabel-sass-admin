/**
 * @Description:发布指定cmsconfig窗口 以前selectionSources里面是产品id，现在是cmsConfigid
 * @author nan
 * @date 2022/5/12
 */
...
Ext.define('CGP.cmslog.view.PublishCmsConfigConfirmWin', {
    extend: 'Ext.window.Window',
    alias: 'widget.publish_cmsconfig_confirm_win',
    modal: true,
    constrain: true,
    maximizable: true,
    layout: 'vbox',
