 ...
 */
Ext.syncRequire(['CGP.partner.view.partnerorderreportconfigmanage.view.DiyEmailsFieldComponent','CGP.mailhistory.controller.overridesubmit']);
Ext.define('CGP.partnerapplymanage.view.ConfirmWindow', {
        ...
        me.bbar = ['->',
            {
                ...
                handler: function () {
                    ...
                    if (me.form.isValid()) {
                        Ext.MessageBox.confirm(i18n.getKey('prompt'),i18n.getKey('confirmto'),callback);
