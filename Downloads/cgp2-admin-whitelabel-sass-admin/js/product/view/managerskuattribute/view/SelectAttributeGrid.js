Ext.define('CGP.product.view.managerskuattribute.view.SelectAttributeGrid', {
    extend: 'CGP.common.field.SearchGrid',
    alias: 'widget.selectattributegrid',
    width: 950,
    height: 500,
    initComponent: function () {
        ...
        me.store = Ext.create('CGP.product.view.managerskuattribute.store.SelectAttributeGridStore', {
            ...
            proxyUrl: adminPath + 'api/products/configurable/' + me.productId + '/generalAttributes?optional=false',
            proxyReader: {
                type: 'json',
                root: 'data'
            }
