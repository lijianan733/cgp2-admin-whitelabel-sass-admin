/**
 * Created by nan on 2018/1/2.
 */
Ext.syncRequire(['CGP.currency.store.Currency', 'CGP.product.view.managerskuattribute.skuattributeconstrainter.view.DiyComponent']);
Ext.define('CGP.product.view.managerskuattribute.skuattributeconstrainter.view.ValidExpressionContainer', {
                ...
                listeners: {
                    'change': function (view, newValue, oldValue) {
                        ...
                        if (newValue == 'com.qpp.cgp.expression.RangeExpression') {
                            this.ownerCt.add([Ext.create('CGP.product.view.managerskuattribute.skuattributeconstrainter.view.DiyComponent', {
                                name: 'min',
                                itemId: 'min',
                                ...
                                Ext.create('CGP.product.view.managerskuattribute.skuattributeconstrainter.view.DiyComponent', {
                                    name: 'max',
                                    itemId: 'max',
                                    configurableId: me.configurableId,
