 ...
 */
Ext.define('CGP.product.view.bothwayattributepropertyrelevanceconfig.view.AddAttributePropertyWindow', {
    extend: 'Ext.window.Window',
    requires: ['CGP.product.view.bothwayattributepropertyrelevanceconfig.model.Attribute'],
    constrain: true,
    width: 400,
    modal: true,
    height: '40%',
