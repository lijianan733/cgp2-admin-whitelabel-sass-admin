 ...
 */
Ext.define("CGP.product.view.bothwayattributepropertyrelevanceconfig.store.Attribute", {
    extend: 'Ext.data.Store',
    model: "CGP.product.view.bothwayattributepropertyrelevanceconfig.model.Attribute",
    proxy: {
        type: 'uxrest',
