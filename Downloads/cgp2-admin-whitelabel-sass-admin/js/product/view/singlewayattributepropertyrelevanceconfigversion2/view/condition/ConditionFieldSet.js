/**
 * Created by nan on 2019/10/17.
 * 简易的判断条件窗口，最终将组成expressDTO的数据
 * profile,有选择切面，属性为该产品所有属性
 *
 *
 */
Ext.define('CGP.product.view.singlewayattributepropertyrelevanceconfigversion2.view.condition.ConditionFieldSet', {
    ...
    initComponent: function () {
        var me = this;
        var conditionGridPanel = Ext.create('CGP.product.view.singlewayattributepropertyrelevanceconfigversion2.view.condition.AttributeMappingRuleConditionFieldSet', {
            leftAttributes: [],
            width: '100%',
            title: '',
            header: false,
        ...
        var profileItem = [];
        Ext.Ajax.request({
            url: encodeURI(adminPath + 'api/attributeProfile?' + 'page=1&start=0&limit=25&filter=[{"name":"productId","value":' + me.productId + ',"type":"number"}]'),
            method: 'GET',
            async: false,
            headers: {
