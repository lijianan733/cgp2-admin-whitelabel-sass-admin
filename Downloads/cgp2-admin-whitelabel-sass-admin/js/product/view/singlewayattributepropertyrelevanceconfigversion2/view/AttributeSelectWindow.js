 ...
 */
Ext.define('CGP.product.view.singlewayattributepropertyrelevanceconfigversion2.view.AttributeSelectWindow',{
                    ...
                    Ext.Array.each(selecteds,function(record){
                        selectedData.push({
                            ...
                            propertyPath:{
                                ...
                                EntryLink : null,
                                skuAttributeId:record.data.id,
                                skuAttribute:record.data,
                                propertyName:'Value',
                                attributeProfile:{
...
//        me.getComponent('productSKUAtt').store.load(
...
//                    });
//                    if(selectedGridAttr.length>0){
//                        me.getComponent('productSKUAtt').getSelectionModel().select(record);
//                    }
//                    if(Ext.Array.contains(me.selectedSkuAttr,record.getId())){
//                        delete record;
//                    }
//                });
//            }
