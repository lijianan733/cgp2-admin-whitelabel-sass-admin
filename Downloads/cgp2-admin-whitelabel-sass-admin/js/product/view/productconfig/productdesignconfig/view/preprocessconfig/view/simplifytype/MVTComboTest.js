Ext.define('CGP.product.view.productconfig.productdesignconfig.view.preprocessconfig.view.simplifytype.MVTComboTest', {
    ...
    initComponent: function () {
        var me = this;
        var mvtStore = Ext.create('CGP.product.view.productconfig.productdesignconfig.view.sourceconfig.store.ProductMaterialViewCfgStore', {
            // storeId:'mvtStore',
            params: {
