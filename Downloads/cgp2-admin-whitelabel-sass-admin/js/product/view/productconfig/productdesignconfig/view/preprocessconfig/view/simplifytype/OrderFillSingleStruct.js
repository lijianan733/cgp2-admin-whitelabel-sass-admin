 ...
 *OrderFillSingleStructPreprocessConfig
 */
...
Ext.define('CGP.product.view.productconfig.productdesignconfig.view.preprocessconfig.view.simplifytype.OrderFillSingleStruct', {
    ...
    getValue: function () {
        ...
        var items = me.items.items,
            result = {clazz: 'com.qpp.cgp.domain.preprocess.config.tile.OrderFillSingleStructPreprocessConfig'};
        if (me.rendered == true) {
