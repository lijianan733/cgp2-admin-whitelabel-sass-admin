Ext.Loader.syncRequire(['CGP.product.view.productconfig.productdesignconfig.view.materialtypetospuconfigs.model.Model']);
Ext.define('CGP.product.view.productconfig.productdesignconfig.view.materialtypetospuconfigs.edit', {
    ...
    initComponent: function () {
        ...
        me.title = i18n.getKey(me.editOrNew) + i18n.getKey('materialTypeToSpuConfig');
            ...
            items: [{
                ...
                handler: function () {
                    ...
                    if (form.isValid()) {
                        ...
                        if (jsonData.materialPath) {
                            me.controller.selectMaterialPath(me.productBomConfigId, jsonData.materialPath, jsonData, dataComp);
                        } else {
                            Ext.Msg.alert(i18n.getKey('prompt'), '数据中无materialPath!')
                            return;
                        }
                ...
                handler: function () {
                    ...
                    if (form.isValid()) {
                        ...
                        if (jsonData._id) {
                            me.controller.updataMaterialTypeToSpuConfig(jsonData, me.store, me)
                        } else {
                            me.controller.newMaterialTypeToSpuConfig(jsonData, me.store, me)
                        }
                    }
                }
            }, {
