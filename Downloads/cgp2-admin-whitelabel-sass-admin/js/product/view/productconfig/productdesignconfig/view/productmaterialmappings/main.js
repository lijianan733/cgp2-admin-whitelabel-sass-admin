...
Ext.define('CGP.product.view.productconfig.productdesignconfig.view.productmaterialmappings.main', {
    ...
    initComponent: function () {
        ...
        var store = Ext.create('CGP.product.view.productconfig.productdesignconfig.view.productmaterialmappings.store.MaterialMapping');
        var controller = Ext.create('CGP.product.view.productconfig.productdesignconfig.view.productmaterialmappings.controller.Controller');
        var grid = Ext.create('CGP.common.commoncomp.QueryGrid', {
            ...
            gridCfg: {
                ...
                tbar: [
                    {
                        ...
                        handler: function () {
                            ...
                            controller.editMaterialMapping(data, store, 'new', me.productConfigDesignId, me.productBomConfigId);
                        }
                    }
                ],
                multiSelect: true,
                ...
                columns: [
                    ...
                    {
                        dataIndex: 'bomItemMappings',
                        text: i18n.getKey('bomItemMappings'),
                        width: 180,
                        xtype: 'componentcolumn',
                        itemId: 'bomItemMappings',
                        renderer: function (value, metadata) {
                            ...
                            return new Ext.button.Button({
                                ...
                                frame: false,
                                width: 100,
                                tooltip: i18n.getKey('check') + i18n.getKey('bomItemMappings'),
                                baseCls: 'uxGridBtn',
                                style: {
                                    background: '#F5F5F5'
                                },
                                handler: function (comp) {
                                    var win = Ext.create("Ext.window.Window", {
                                        ...
                                        modal: true,
                                        layout: 'fit',
                                        title: i18n.getKey('bomItemMappings'),
                                        items: [
                                            {
                                                xtype: 'textarea',
                                                fieldLabel: false,
                        ...
                        dataIndex: 'spuRtObjectMappings',
                        text: i18n.getKey('spuRtObjectMappings'),
                        width: 180,
                        xtype: 'componentcolumn',
                        itemId: 'spuRtObjectMappings',
                        renderer: function (value, metadata) {
                            if (Ext.isEmpty(value)) {
                                return;
                            }
