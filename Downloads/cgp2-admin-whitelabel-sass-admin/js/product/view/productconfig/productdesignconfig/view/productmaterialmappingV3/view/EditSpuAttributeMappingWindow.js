 ...
 */
Ext.define("CGP.product.view.productconfig.productdesignconfig.view.productmaterialmappingV3.view.EditSpuAttributeMappingWindow", {
    ...
    setValue: function (data) {
        ...
        form.items.items.forEach(function (item) {
            if (item.getName() == 'outputValue') {
                ...
                if (item.xtype == 'attributejsexpressioninputfield') {
                    item.setValue(outputValue);
                } else {
                    if (me.skuAttribute.rtAttributeDef.selectType == 'MULTI') {
    ...
    initComponent: function () {
        ...
        me.title = i18n.getKey(me.createOrEdit) + i18n.getKey('spuAttributeMapping');
        ...
        me.items = [
            {
                ...
                items: [
                    ...
                    controller.createFieldByAttribute(me.skuAttribute, null, null, 'com.qpp.cgp.domain.executecondition.operation.value.FixValue', excludeAttributeValue),
                    {
                    ...
                    '->',
                    {
                        ...
                        handler: function (btn) {
                            ...
                            if (isValid == true) {
                                    ...
                                    if (item.disabled == false) {
                                        if (item.getName() == 'outputValue') {
                                            if (item.xtype == 'attributejsexpressioninputfield') {
                                                ...
                                                if (win.skuAttribute.rtAttributeDef.selectType == 'MULTI') {
                                                    var multiValue = item.getValue();
                                ...
                                data.materialAttName=me.skuAttribute.name;
