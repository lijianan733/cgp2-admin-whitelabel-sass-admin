...
Ext.Loader.syncRequire([
    'CGP.product.view.productconfig.productdesignconfig.view.pcresource.model.PCResourceLibraryModel',
        ...
        formCfg: {
            ...
            items: [
                ...
                },
                {
                    ...
                    hidden: true,
                    itemId: 'clazz',
                    value: 'com.qpp.cgp.domain.pcresource.BusinessLibraryOfProductConfigDesign',
                    allowBlank: false,
                },
                {
                    name: 'productConfigDesign',
                    xtype: 'textfield',
                    fieldLabel: i18n.getKey('productConfigDesign'),
                    hidden: true,
