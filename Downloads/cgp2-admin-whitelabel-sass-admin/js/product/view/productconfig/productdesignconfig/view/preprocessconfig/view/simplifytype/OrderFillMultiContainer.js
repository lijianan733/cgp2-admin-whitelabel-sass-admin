 ...
 *OrderFillMultiContainerPreprocessConfig  complete
 */
Ext.Loader.syncRequire([
    'CGP.product.view.productconfig.productdesignconfig.view.preprocessconfig.view.simplifytype.BaseForm',
    "CGP.product.view.productconfig.productdesignconfig.view.preprocessconfig.view.simplifytype.MVTGridField",
...
Ext.define('CGP.product.view.productconfig.productdesignconfig.view.preprocessconfig.view.simplifytype.OrderFillMultiContainer', {
    ...
    getValue: function () {
        ...
        var items = me.items.items,
            result = {clazz: 'com.qpp.cgp.domain.preprocess.config.tile.OrderFillMultiContainerPreprocessConfig'};
        if (me.rendered == true) {
