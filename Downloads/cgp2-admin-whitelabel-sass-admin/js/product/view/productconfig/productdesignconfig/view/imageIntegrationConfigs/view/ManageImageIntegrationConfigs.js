...
Ext.define('CGP.product.view.productconfig.productdesignconfig.view.imageIntegrationConfigs.view.ManageImageIntegrationConfigs', {
            ...
            listeners:{
                load:function (store,records){
                    store.filterBy(function (record, id) {
                        var imags=record.get('imagePageContentPaths');
                ...
                tbar: [
                    {
                        ...
                        iconCls: 'icon_create',
                        handler: function () {
                            controller.editImageIntegrationConfigs(null, store, 'new', me.productConfigDesignId, me.productBomConfigId);
                        }
                    },
                    {
                        xtype: 'button',
                        ...
                        handler: function (btn) {
                            imageIntegrationController.batchAdd(store, me.productConfigDesignId, me.productBomConfigId,'basePC');
                        ...
                        items: [
                            {
                                ...
                                handler: function (view, rowIndex, colIndex, a, b, record) {
                                    controller.editImageIntegrationConfigs(record.data, store, 'modify', me.productConfigDesignId, me.productBomConfigId);
                                }
                            },
                            {
