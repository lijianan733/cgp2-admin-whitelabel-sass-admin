...
Ext.Loader.syncRequire([
    'CGP.product.view.productconfig.productdesignconfig.view.productmaterialviewtype.view.pcresource.store.PCResourceLibraryStore',
    'CGP.businesstype.store.BusinessTypeStore',

])
Ext.onReady(function () {
    var store = Ext.create('CGP.product.view.productconfig.productdesignconfig.view.productmaterialviewtype.view.pcresource.store.PCResourceLibraryStore', {
        params: {
            filter: Ext.JSON.encode([{
                name: 'materialViewType._id',
                type: 'string',
                value: JSGetQueryString('MVTId')
            }])
        }
    });
            ...
            btnCreate: {
                handler: function (view) {
                    builderConfigTab.addNewTab({
                        id: 'MVTPCResourceLibrary_edit',
                        url: path + 'partials/product/productconfig/productdesignconfig/productmaterialviewtype/pcresource/edit.html' +
