Ext.define("CGP.product.view.productconfig.productdesignconfig.view.BomTree", {
    ...
    initComponent: function () {
        ...
        var bomItemIcon = path + 'ClientLibs/extjs/resources/themes/images/ux/B.png';
        me.title = i18n.getKey('choice') + i18n.getKey('material');
        ...
        store.on('load', function (store, node, records) {
            Ext.Array.each(records, function (item) {
                ...
                if (type == 'MaterialType') {
                    item.set('icon', typeIcon);
                } else if (type == 'MaterialSpu') {
                    item.set('icon', spuIcon);
                } else {
                    item.set('icon', bomItemIcon);
                }
            });
