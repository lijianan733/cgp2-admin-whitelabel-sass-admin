 ...
 */
Ext.define('CGP.product.view.productconfig.productviewconfig.view.navigationV2.store.SimplifyBomNodeTreeStore', {
    extend: 'Ext.data.TreeStore',
    model: 'CGP.product.view.productconfig.productviewconfig.view.navigationV2.model.SimplifyBomNodeModel',
    nodeParam: '_id',
    root: {
        _id: 'root',
        name: ''
