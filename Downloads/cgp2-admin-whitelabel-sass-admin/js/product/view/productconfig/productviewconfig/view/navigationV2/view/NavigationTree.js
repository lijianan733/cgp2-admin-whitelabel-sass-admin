Ext.syncRequire([]);
Ext.define("CGP.product.view.productconfig.productviewconfig.view.navigationV2.view.NavigationTree", {
    ...
    initComponent: function () {
        ...
        var controller = Ext.create('CGP.product.view.productconfig.productviewconfig.view.navigationV2.controller.Controller');
        var store = Ext.create('CGP.product.view.productconfig.productviewconfig.view.navigationV2.store.NavigationStore', {
