 ...
 */
Ext.define('CGP.product.view.productconfig.productviewconfig.view.builderconfigV2.view.CommonFontColorFieldSet', {
    extend: 'Ext.ux.form.field.UxFieldSet',
    alias: 'widget.commonfontcolorfieldset',
    legendItemConfig: {
        disabledBtn: {
            hidden: false,
            disabled: false,
                ...
                listeners: {
                    change: function (combo, newValue, oldValue) {
                        ...
                        if (newValue == 'Replace') {
                            ...
                            colors.searchGridCfg.gridCfg.storeCfg.proxy = {
                                type: 'uxrest',
                                url: adminPath + 'api/commonbuilderresourceconfigs/V2/fontColors',
                                reader: {
                                    type: 'json',
                                    root: 'data.content'
                                }
