...
Ext.define("CGP.product.view.pricingStrategyv2.view.PricingStrategyEdit", {
                ...
                handler: function (view) {
                    ...
                    if (form.getForm().isValid()) {
                        ...
                        var translateData = function (data) {
                            ...
                            data.formula.formula.expression = controller.translateSimpleSetting(data.setting);
                            delete data.table;
