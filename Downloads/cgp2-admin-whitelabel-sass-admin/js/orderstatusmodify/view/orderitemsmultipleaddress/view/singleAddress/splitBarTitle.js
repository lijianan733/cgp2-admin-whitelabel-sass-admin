 ...
 * @date 2023/8/24
 */
Ext.define('CGP.orderstatusmodify.view.orderitemsmultipleaddress.view.singleAddress.splitBarTitle', {
    ...
    title: '',
    addButton: null,
    btnSetContainerHideId: 'container',
        ...
        me.items = Ext.Array.merge([
            {
                ...
                handler: function (btn) {
                    const form = btn.ownerCt.ownerCt,
                        ...
                        container = form.getComponent(me.btnSetContainerHideId);
