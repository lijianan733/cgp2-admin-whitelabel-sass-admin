 ...
 */
Ext.define("CGP.dsdatasource.controller.Controller",{
    /**
     * 在dsdatasource中从dataSourceId直接点击查看dataSource
     * @param {String} dsId
     */
...
//		object.promotionId = 1;
            ...
            if(dataSource != null &&
                dataSource.modelName == "CGP.dsdatasource.model.DsdataSource"
                ...
                success : function(response,options){
                    ...
                    if(resp.success){
                        ...
                        Ext.Msg.alert(i18n.getKey('info'),i18n.getKey('saveSuccess'),function(){
                            ...
                            var htmlUrl =  path + "partials/dsdatasource/edit.html?id=" + id;
                            JSOpen({
                                id : "dsdatasource_edit",
                                url :  htmlUrl,
                                title: i18n.getKey('edit') +"_"+ i18n.getKey('dsdatasource'),
                                refresh: true
                            });
                        });
                    }else{
