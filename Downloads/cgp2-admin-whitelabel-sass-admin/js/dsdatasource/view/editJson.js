Ext.define('CGP.dsdatasource.view.editJson', {
    ...
    initComponent: function () {
        ...
        if (Ext.isEmpty(me.dataSourceModel)) {
            previewData = {};
        } else {
            previewData = me.dataSourceModel.data;
        }
        ...
        me.bbar = [
            '->',
            {
                ...
                handler: function (comp) {
                    ...
                    var controller = Ext.create('CGP.dsdatasource.controller.Controller');
                    controller.addPageTemplateConfigWin(jsonData, me.dataSourceModel, mask);
