 ...
 */
Ext.define('CGP.tools.freemark.template.view.KeyRecord', {
        ...
        me.items = [
            {
                xtype: 'textfield',
                name: 'name',
                fieldLabel: i18n.getKey('variableName'),
                allowBlank: false,
                regex:new RegExp("^[A-Za-z]+[A-Za-z0-9_-]*$"),
                emptyText:'字母开头的字母、数字、-、_的组合',
                regexText:'字母开头的字母、数字、-、_的组合',
                // regexText:'只允许字母开头的字母、数字、-、'+String.fromCharCode('_'.charCodeAt()+65248)+'的组合',//String.fromCharCode('_'.charCodeAt()+65248) 字符转全角
                maxLength:50
            },
            {
                xtype: 'combo',
