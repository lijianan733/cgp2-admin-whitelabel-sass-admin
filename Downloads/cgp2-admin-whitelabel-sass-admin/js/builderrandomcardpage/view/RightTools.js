...
Ext.define('CGP.builderrandomcardpage.view.RightTools', {
    ...
    initComponent: function () {
        const me = this,
            {parentComp, orderItemId, productInstanceId} = me,
            evenType = 'render',
            controller = Ext.create('CGP.builderrandomcardpage.controller.Controller'),
            store = Ext.create('CGP.builderrandomcardpage.store.MaterialStore', {
                /* id: orderItemId,
        ...
        me.items = [
            ...
            },
            {
                ...
                name: 'viewType',
                itemId: 'viewType',
                valueField: 'newMaterialName',
                displayField: 'newMaterialName',
                lastQuery: '',
                colspan: 2,
    ...
    dealInitData: function (store, idProperty) {
        ...
        storeData.forEach(item => {
            ...
            if(idProperty === data['idProperty']){
                var materialViews = data['materialViews'];
                result = materialViews.map(item=>{
                    item['designMethod'] = data['designMethod'];
                    return item;
                })
            }
        })
