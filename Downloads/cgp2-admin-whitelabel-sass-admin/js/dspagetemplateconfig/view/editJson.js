Ext.define('CGP.dspagetemplateconfig.view.editJson', {
    ...
    maximizable: true,
    itemId: "showJsonData",
    alias: 'widget.pagetemplateInfo',

    initComponent: function () {
        var me = this;
        var previewData;
        me.title = i18n.getKey(me.createOrEdit);
        if (Ext.isEmpty(me.pagetemplateconfigModel)) {
            previewData = {};
        } else {
            previewData = me.pagetemplateconfigModel.data;
        }
        ...
        me.bbar = [
            '->',
            {
                ...
                handler: function (comp) {
                    ...
                    var controller = Ext.create('CGP.dspagetemplateconfig.controller.Controller');
                    controller.addPageTemplateConfigWin(jsonData, me.pagetemplateconfigModel, mask);
