Ext.define('CGP.orderdetails.view.shipment.ShipmentBoxGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.shipmentboxgrid',
    requires: [
        'CGP.orderdetails.model.ShipmentBox',
        'CGP.orderdetails.store.ShipmentBox'
    ],
    ...
    initComponent: function () {
                    ...
                    renderer: function (v, m, r) {
                        return {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'combobox',
                                    store: Ext.create('CGP.orderdetails.store.BoxSizeUnit'),
                                    editable: false,
                                    displayField: 'title',
                                    valueField: 'vlaue',
                                    name: 'boxSizeUnit',
        ...
        me.listeners = {
            el: {
                keyup: function (event, dom, scope) {
                    if (event.keyCode === 13) {
                        event.target.blur();
                        var inputs = new Ext.dom.Element(event.currenctTarget).query('input');
                        var index = Ext.Array.indexOf(inputs, event.target);
